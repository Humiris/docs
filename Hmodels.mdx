...
| Model Name           | Context Window (Tokens) Max Completion Token Description | Pricing (per million tokens) | Description                                                                                     |
| -------------------- | -------------------------------------------------------- | ---------------------------- | ----------------------------------------------------------------------------------------------- |
| `codiris-v1-preview` | 1M                                                       | 50,000                       | Codiris, our first multimodal, post-trained engineered specifically for complex code workflows. |
| `codiris-v1-mini`    | 1M                                                       | 50,000                       | Cost-efficient, post-trained built for coding                                                   |
...
- Choose **Vertical model **for coding. (Other models for domain like Fintech, Healthtech will be available soon)