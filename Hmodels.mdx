...
| **Model**              | **Context Window (Tokens** | **Max Completion Token** | **Description**                                                                                     | Pricing (per million tokens) |
| :--------------------- | :------------------------- | :----------------------- | :-------------------------------------------------------------------------------------------------- | ---------------------------- |
| **codiris-v1-preview** | **1M**                     | **50,000**               | **Codiris**, our first multimodal, post-trained engineered specifically for complex code workflows. | Input: \$10, Output: \$30    |
| **codiris-v1-mini**    | **1M**                     | **50,000**               | Cost-efficient, post-trained built for coding                                                       | Input:   \$3, Output: \$15   |
